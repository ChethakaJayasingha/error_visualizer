                      ...
                      <tbody>
                        {result.tokens.map((token, idx) => (
                          <tr key={idx} className="hover:bg-gray-100">
                            ...
                            <td className="border border-gray-300 px-4 py-2 font-semibold text-indigo-600">
                              {token.type}
                            </td>
                            <td className="border border-gray-300 px-4 py-2 font-mono">
                              {token.value || "EOF"}
                      ...
                      <tbody>
                        {result.symbolTable.map((symbol, idx) => (
                          <tr key={idx} className="hover:bg-gray-100">
                            ...
                            <td className="border border-gray-300 px-4 py-2 text-purple-600 font-semibold">
                              {symbol.type}
                            </td>
                            <td className="border border-gray-300 px-4 py-2 font-mono">
                              {symbol.firstOccurrence}
                            </td>
                            <td className="border border-gray-300 px-4 py-2 font-mono">
                              {symbol.occurrences.join(", ")}
                            </td>
                          </tr>
                        ))}
                      </tbody>
                ...
                <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-6 rounded-xl shadow-lg">
                  ...
                  <div className="bg-white p-6 rounded-xl border-2 border-gray-200 overflow-x-auto shadow-inner">
                    <div className="text-sm mb-3 text-gray-600 italic">
                      📊 Tree structure showing the derivation of your
                      expression:
                    </div>
